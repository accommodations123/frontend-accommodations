...
export default function SearchPage() {
    ...
    const listings = approvedProperties?.map(property => ({
        _id: property.id,
        title: property.title || "Untitled Property",
        location: property.city || "Unknown",
        price: property.price_per_month || property.price_per_night || 0,
        currency: property.currency || 'INR',
        image: (property.photos && property.photos.length > 0) ? property.photos[0] : "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?q=80&w=2070&auto=format&fit=crop",
        images: property.photos || [],
        type: property.property_type || "Stay",
        category: property.category_id || "Apartment",
        badges: ["Verified"]
    })) || [];
