...
export default function CareerPage() {
    ...
    const filteredJobs = useMemo(() => {
        return JOBS.filter(job => {
            ...
            const matchesStatus = selectedFilters.applicationStatus.length === 0 || (job.applicationStatus && selectedFilters.applicationStatus.includes(job.applicationStatus))

            return matchesSearch && matchesLocation && matchesExperience && matchesType && matchesStatus
        })
                    ...
                    <aside className="hidden lg:block w-72 flex-shrink-0">
                        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sticky top-24">
                            <div className="flex items-center justify-between mb-6">
                                ...
                                {(selectedFilters.locations.length > 0 || selectedFilters.experience.length > 0 || selectedFilters.type.length > 0 || selectedFilters.applicationStatus.length > 0) && (
                                    <button
                            ...
                            <div className="space-y-2">
                                <FilterSection
                                    ...
                                    options={FILTERS.applicationStatus}
                                    selected={selectedFilters.applicationStatus}
                                    onChange={(val) => toggleFilter('applicationStatus', val)}
                                />
                                <FilterSection
                                    title="Location"
