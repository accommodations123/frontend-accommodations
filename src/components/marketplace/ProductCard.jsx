        ...
        >
            ...
            <div className="p-3 flex flex-col flex-1">
                ...
                <div className="flex items-center gap-2 mb-2">
                    <Badge variant="secondary" className="text-[10px] px-1.5 py-0 h-5 bg-gray-100 text-gray-600 font-medium border-gray-200">
                        {product.condition}
                    </Badge>
                    <span className="text-[10px] text-gray-400">•</span>
                    <span className="text-[10px] text-gray-500 flex items-center gap-0.5">
                        <Clock className="h-3 w-3" /> {product.postedTime || new Date(product.createdAt).toLocaleDateString()}
                    </span>
                </div>

                <div className="mt-auto pt-3 border-t border-gray-50 flex items-center justify-between">
                    <div className="flex items-center gap-1 text-[11px] text-gray-500 truncate max-w-[50%]">
