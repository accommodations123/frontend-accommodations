...
export function SearchFilters() {
    ...
    const minPrice = convert(priceRange[0])
    const maxPrice = convert(priceRange[1])
            ...
            <div>
                ...
                <div className="px-2">
                    <div className="flex items-center justify-between mb-2">
                        <span className="text-sm">{symbol}{minPrice}</span>
                        <span className="text-sm">{symbol}{maxPrice}+</span>
                    </div>
                    <input
                        type="range"
                        min="0"
